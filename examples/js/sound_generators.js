...
AFRAME.registerComponent("polysynth", {
    ...
    init: function () {
        ...
        */
            ...
            this.polysynth = new Tone.PolySynth().set({
                oscillator: {
                    type: "sine" //the type of waveform the synthesizer produces. Can be: square, sine, triangle, or sawtooth
                },
                polyphony : 4 ,
                voice : Tone.Synth,
                envelope: {
        ...
        */
        ...
        this.polysynth.chain(this.filter, this.distortion , this.pannerpolysynth, Tone.Destination)
